...
$(function(){
	//x 처음 누를시 안되게 함
	//$(".schoolRemoveBtn").prop("disabled",true);
	...
	$(".schoolAddBtn").click(function(){
		...
		//$(".schoolRemoveBtn").prop("disabled",false);
		$(".schoolRemoveBtn").show();
		//clone(true) true를 줘야 이벤트까지 복제가 된다.
		var p = $(this).closest(".input-box").find("div:first-child :first").clone(true);
		$(this).closest(".input-box").find("div:first").append(p);
	});
	
	$(".schoolRemoveBtn").click(function(){
...
$(function(){
	...
	$(".licenseRemoveBtn").click(function(){
		if($(this).closest("div").find("p").length<=1){
			return;
		}
