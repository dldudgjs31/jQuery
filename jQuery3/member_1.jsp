	...
	<div>*별표가 표시된 곳은 필수 입력사항입니다.</div>
			...
			<tr height="40" style="border-top: 1px solid #cccccc;">
				...
				<td align="left" style="padding-left: 5px;">
					...
					<span>*</span>
					<span class="info-box">2000-00-00 형식으로 입력하시오</span>
			...
			<tr>
				<td align="center" colspan="2">
				    <button type="button" class="btn" id="btnOk"> 회원가입 </button>
